...
Definition:
Interaktionskonzeote die nicht auf quasi_Standard Konzepten basieren wie z.B. Touchscreens, Maus & Tastatur etc.
...
2. Räumliche - Nichträuimliche Ausdehnung
...
4. Räumliche Ortsbezogenheit - Referenzielle Ortsbezogenheit
    * Physische Objekte in räumliche Umgebung eingebettet, implizit verknüpft vs. virtuelle Objekte häufig durch Referenzen verknüoft
...
1. Physische Materie
    ...
    2. Können physisch und mental gleichzeitig be- / begriffen werden
        ...
        * Haptisches Begreifen verbessert mentales Begreifen
    3. Direkte, passive haptische Rückmledung
...
3. Räumliche Position
    ...
    4. Erlauben oarallele räumliche Multiplexkontrolle
...
1. Binäre Substanz
    ...
    3. Können aus dem nichts enstehen und kopiert werden
    4. Können ienfach gespeichert, zurückgesetzt und gelöscht werden
        * Nur im Speicher existene
...
4. Referenzielle Ortsbezogenheit
    1. Komplexe Hierarchisceh und vernetzte Strukturen einfach abbildbar
...
### Gestenbasierte Interaktion & Mulittouch
